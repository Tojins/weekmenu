...
DROP POLICY IF EXISTS "Only admins can read recipe_search_history" ON recipe_search_history;
...
DROP POLICY IF EXISTS "Only admins can read recipe_url_candidates" ON recipe_url_candidates;
